...
import adventuregame.Direction;
	...
	public static void init() {
		Room cavern = new Room("Cavern",
				"This room has exits to the north and south. There is also a spiral staircase leading down.  There is an inscription on the wall.")
						.makeDark();
		new Item("inscription", "'Find the merchant to fulfill your destiny.'", Map.syn("inscription"))
				.detailInRoom(cavern);
		new Item("Magic Lightbulb", "", Map.syn("bulb", "magic lightbulb", "lightbulb")).inRoom(cavern)
				.isLightsource(true);
		...
		smallcavern.addexit("south", smallcavern, Room.Special.NO_REVERSE_ROOM);
		...
		cavern.addTrigger(new Trigger().addRequirement(Trigger.createCommandReq("down"))
		...
		whistleroom.addTrigger(new Trigger().addRequirement(Trigger.createCommandReq("up"))
				.addRequirement(Trigger.createNotReq(Trigger.createLightInInventoryReq()))
		...
		Item whistle = new Item("Steel Whistle", "A steel whistle.", Map.syn("steel whistle", "whistle"))
				.inRoom(whistleroom);
		...
		Item magickey = new Item("Magic Key", "With this key, you win.", Map.syn("magic key", "key"));

		Item gate = new Item("golden gate", "Gate made of gold.  Don't steal it.",
				Map.syn("golden gate", "gold gate", "gate")).detailInRoom(goldengate);
		...
		/* Item adventurer = */new Item("adventurer", "It is pointless, he is dead.",
				Map.syn("dead body", "body", "adventurer")).detailInRoom(dungeon);
		/* Item medallion = */new Item("Silver Medallion", "Lucky medal belonging to the adventurer.  It may not work.",
				Map.syn("silver medallion", "medal", "medallion")).inRoom(dungeon);
		/* Item mace = */new Item("Mace", "A black war mace.", Map.syn("mace")).inRoom(dungeon);
		/* Item axe = */new Item("Battle Axe", "A heave battle axe.", Map.syn("axe", "battle axe")).inRoom(dungeon);
		...
		Item canteen = new Item("Canteen", "A steel camping canteen.", Map.syn("canteen")).inRoom(riverroom);
		...
		// 902 print "there are many potted plants in this room. all need water. the
		// exit is to the west."
		...
		// 1102 print "the troll disapears into an unseen passage. you are in a small
		// room with exits to the east and the west. there is a glass staircase leading
		// up. big scratchesand blood stains cover the walls."

		// 1200 print "trophy room"
		// 1204 print "you are in a hidden room with treasures piled to the cieling.
		// upon closer examination you realize all of the treasured have traps hooked to
		// them."
		// 1209 if ih$<>"sword" then print "there is an elvin sword here that is not
		// hooked up to a trap."

		// 1300 print "drain"
		// 1310 print "you are under water."
		// 1312 print "the exits are to the west and to the south. you must struggle to
		// stop yourself from being dragged down into the drain."
		// 1315 if ik$<>"safe" then print "there is a safe here."

		// 1400 print "rag room"
		// 1401 print "there are exits to the north and east. you hear a faint murmur to
		// the east."
		...
		// 1510 print "you are in a room with exits to the north and east. a green
		// staircase leads up"
		// 1513 if in$<>"sphere" then print "there is a bright sphere in the middle of
		// the room"
		...
		// 1702 print "this room has a brilliant red floor with three squares of yellow
		// on it. the walls are grey and painted on the south wall is a picture of the
		// great dimwit flathead. the room smells like roses and a flourescent green
		// staircase leads "
		// 1704 if cup$="" then print "down. there is an empty cup here that is bolted
		// to the floor." else print "down. there is a cup here filled with water and a
		// door to the west."
		// 1732 if iff$="canteen and water" then print "sorry, wrong kind of water" else
		// goto 1734
		// 1738 iff$="canteen":cup$="cup and waterfall water":print "a door opens to the
		// west":west=1

		// 1800 print "white room"
		// 1801 print "you are in a white room with pretty black curtians over the
		// window. out side the window is a train station. there is a large control
		// panel in the middle of the room which apears to be securly bolted to the
		// floor."
		// 1802 print "there is a bucket type part on the machine. it is labeled
		// 'infinite improbability drive'. there are exits to the west and south.":if
		// itea$<>"cup of tea" then print "there is a cup of tea here."
		// 1803 if io$<>"sheet of music" then print "there is a sheet of music here."

		// 1900 print "shore"
		// 1901 print "you are on a beach. exits are to the west or up a ladder. the
		// river is to the east."

		// 2000 print "whisper room"
		// 2001 print "in this room, thousands of voices whisper to you. the exits are
		// to the west, north, and northeast."
		// 2060 if a$="listen" then print"you hear a little poem: when lost within the
		// halls of glass, don't wave the wand - you'll roast your...rump!"

		// 2100 print "wizard room"
		// 2101 print "the room is filled with mist. you can go east or west. to the
		// south is a magical box you can get into."

		// 2200 print "roof of house"
		// 2201 print "up, down, or west?"
		// 2202 if ip$<>"lightning rod" then print "there is a lightning rod in the
		// room."

		// 2300 print "alice room"
		// 2301 print "you are in a room with an exit to the east and a mirror on the
		// west wall."

		// 2400 print "lightning room"
		// 2401 print "this is a large room. exits are north and down"
		// 2402 if ip$<>"lightning rod" then print "bolts of electricity criss-cross the
		// room. you are likely to be struck by lightning."
		// 2403 if ip$="lightning rod" then rytufjnreu$="lw;ekfj":if ir$<>"magic wand"
		// then print "there is a wand here."
		...
		// 2701 print "exits are to the west and down. there is a box here that you can
		// get into."
		// 2702 if ist$<>"magic book" then print "there is a magic book here"

		// 2780 if a$="take book" then klhbb$="ljk":if ir$<>"magic wand" then print "you
		// can't take the book because of a magical force field protecting it!":goto
		// 2790
		...
		// 3005 print "you are in a room with an exit to the west and a mirror on the
		// east wall."
		...
		// 3606 if is$<>"sticky substance" then sklfihv$="sakgb":if is$<>"honey" then
		// print "there is a sticky subtance here."
		// 3610 gosub 25000
		// 3620 if left$(a$,4)="take" then print "done":print:is$="sticky
		// substance":goto 3610
		...
		// 3900 print "bee room"
		// 3901 print "this is a small room. in the middle of the room is a bee hive.
		// the exits are to the east, north, and southwest. the room is filled with
		// bees."
		// 3902 if is$<>"" then print "the bees are flocking to your honey.":if
		// it$<>"gold coin" then print " there is a coin here.":is$="honey"

		// 4000 print "merchant room"
		// 4001 print "a small room with four walls. there is a merchant here. you can
		// go west."
		// 4002 if iz$="key" then goto 4010
		// 4003 print "the merchant will give you a key if you give him your valuables."
		// 4004 print "to give stuff to the merchant type 'give ";:color 12:print
		// "item";:color 15:print "'"

		// 4100 print "flute room"
		// 4101 print "a small room with boards nailed over doors to the north and
		// south. exit are to the east and up."
		...
		// 4505 print "above you head there is an intricate system of clockwork gears
		// operating a bell every 10 seconds. an exit lead south and another lead east."

		// 4600 print "prisoner room"
		// 4602 print "there is an exit to the north and south."
		// 4604 if iw$<>"bloody knife" then print "there is a body here with a knife
		// sticking in to it."
		...
		// 4805 print "in this room there are about five complete skeletons and at least
		// twenty-five parts of other adventurers. the exit is to the northwest.":if
		// ix$<>"jade staff" then print "there is a jade staff here."
		// 4806 if ogre$<>"ogre" then print "there is and ogre here finishing his last
		// meal." else print "there is a distinct lack of an ogre here"

		// 4900 print "west hall"
		// 4901 print "in this room the wall gradually slopes to form the high ceiling.
		// there are many benches here. the exits are to the southeast, south, and
		// north."
		...
		// 5104 print "this room is filled with a magic darkness so powerful that only
		// your bright sphere can cut through it. the exit is to the south."
		// 5106 if iaa$<>"gold watch" then print "the floor consists of several loose
		// boards that look like they can be moved."
		...
		// 5302 print "this is a long wide room with tall ceilings. beams with intricut
		// ingravings suport the wall. exits are to the west and northwest."
		// 5304 if iab$<>"brass shield" then print "there is a brass shield on the wall"

		// 5400 print "music room":flute=1
		// 5402 if music=0 then print "the exit is to the east. the room is drab. the
		// walls are gray."
		// 5404 if music=1 then print "the room seems to come alive... you begin to
		// notice bright patches of color which you did not notice before. a red door
		// appears to the south. there is an exit to the east."

		// 5500 if falss<>2 then print "waterfall" else print "base of cliff"
		// 5502 if falss<>2 then print "you are the foot of the spectacular flathead
		// falls. next to you is the water crashing down on the rocks creating a
		// refreshing mist. there is a red door in the cliff face to the north.":goto
		// 5504
		// 5503 print "you are standing at the foot of the spectacular flathead
		// no-falls. next to you is the no-water crashing down creating a not-refreshing
		// no-mist. there is a reddoor to the north."
		// 5504 if falls=1 then print "you can also go east."
		// 5505 if falls=0 then print "(hint: it involves a small spark of minor
		// magic.)"

		// 5600 print "behind waterfall"
		// 5602 print "there is an exit to the west":if iac$<>"pixie dust" then print
		// "there is some pixie dust laying on the rocks here."

		// 5900 print"dungeon":print "this room is a dark and dirty dungeon cell much
		// like many others. there are skeletons chainned to the wall here. there are
		// exits to the north, south, and west."

		// 6000 print "closet"
		// 6002 print "you are standing in a closet. the exit is to the east."
		// 6004 if iad$<>"pearl necklace" then print "you see a pearl necklace on a
		// shelf here."
		// 6100 print "pointless room ii"
		// 6102 print "you can hear what appears to be children laughing in the
		// distance. on the northwall in an inscription. above you is a songbird flying
		// in circles. above the door to the south is a picture. there is a window here
		// through which you see a"
		// 6103 print "dork. oh never mind. it wasn't a window after all...just a little
		// mirror. there is also a door to the north."
		// 6200 print"specious shrine"
		// 6202 print"as you take a quick look around the room, you immediately realize
		// that a large altar occupies much of the northern half of the room. on the
		// altar is a burnt offering of some kind, and behind the altar is a huge
		// carving with something ":
		// 6203 print"written at its base. at your feet lies a monk. you can go east or
		// south."
		// 6300 print "the room to end all rooms"
		// 6302 print "the room you are standing in is apparently part of a house owned
		// by a very insane or very eccentric dwarf. the exits are to the north, into
		// what seems to be the entrance to a cave; west through a revolving glass door;
		// and down a "
		// 6303 print "spiral staircase; there is an exit to the east through a hole in
		// the wall just large enough to crawl through."
		...
		// 6702 if inot$<>"book" then print "there is a book here and a rope ladder
		// leading up." else print "you can go up."

		Map.doNavigate(cavern);
	}
